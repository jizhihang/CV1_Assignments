...
num2str(step_size), '_', num2str(block_size), '_', num2str(vocab_size),'.html');
...
fprintf(file_id,  ['<!DOCTYPE html>'...
                ...
                '  </head>'...
                '  <body>']);
fprintf(file_id, '<h2>%s, %s</h2>', 'Mircea Mironenco', 'Bogdan Teleaga');
...
fprintf(file_id, ['<tr><td><img src="%s" /></td>'...
                  '<td><img src="%s" /></td>'...
                  '<td><img src="%s" /></td>'...
                  '<td><img src="%s" /></td></tr>'],...
