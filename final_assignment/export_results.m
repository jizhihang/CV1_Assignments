...
file = strcat('./htmls/result_', dense, '_', sift_type, '_',... 
num2str(step_size), '_', num2str(block_size), '_', num2str(vocab_size), '_',...
num2str(num_train), '_', num2str(vocab_freq), '_', kernel,'.html');
fid = fopen(file, 'w');
...
fprintf(fid, ['<tr><td><img src="%s" /></td>'...
                  ...
                  '<td><img src="%s" /></td>'...
                  '<td><img src="%s" /></td></tr>'],...
                strcat('../', test_files{airplane_rk(i, 3)}),... 
                strcat('../',test_files{cars_rk(i, 3)}),...
                strcat('../',test_files{faces_rk(i, 3)}),... 
                strcat('../',test_files{motorbikes_rk(i, 3)}));
end
